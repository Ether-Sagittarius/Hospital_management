...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 28, 2020 at 03:53 PM
...
(1, 'admin', 'admin@example.com', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8');
...
CREATE TABLE `bed_allotment` (
  ...
  `patient_id` int(11) DEFAULT NULL,
  `allotment_timestamp` longtext DEFAULT NULL,
  `discharge_timestamp` longtext DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
('067lmsucbgicg2acv15mdjvdsriihjt4', '::1', 1598595203, 0x5f5f63695f6c6173745f726567656e65726174657c693a313539383539353230323b61646d696e5f6c6f67696e7c733a313a2231223b6c6f67696e5f757365725f69647c733a313a2231223b6e616d657c733a353a2261646d696e223b6c6f67696e5f747970657c733a353a2261646d696e223b),
('384vmls6cohphqfu3eb621o2j14oo476', '::1', 1598595202, 0x5f5f63695f6c6173745f726567656e65726174657c693a313539383539353230323b61646d696e5f6c6f67696e7c733a313a2231223b6c6f67696e5f757365725f69647c733a313a2231223b6e616d657c733a353a2261646d696e223b6c6f67696e5f747970657c733a353a2261646d696e223b);
...
CREATE TABLE `diagnosis_report` (
  ...
  `report_type` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `document_type` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `language` (
  ...
  `portugese` longtext COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `medicine` (
  ...
  `manufacturing_company` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `medicine_sale` (
  ...
  `patient_id` int(11) DEFAULT NULL,
  `medicines` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `note` (
  ...
  `timestamp_create` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `timestamp_last_update` longtext COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `pathology_report` (
  ...
  `pathology_report` longtext DEFAULT NULL
...
CREATE TABLE `patient` (
  ...
  `birth_date` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `age` int(11) DEFAULT NULL,
...
CREATE TABLE `prescription` (
  ...
  `doctor_id` int(11) DEFAULT NULL,
  `patient_id` int(11) DEFAULT NULL,
  `case_history` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `medication` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `note` longtext COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
